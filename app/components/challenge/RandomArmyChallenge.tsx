        ...
        selectedVariant && (
          <div className="mt-3 rounded-xl border border-white/10 bg-black/20 p-2.5 sm:p-3">
            ...
            {selectedVariant.originalArmy != null && (
              <div className="mb-3 rounded-xl border border-yellow-400/20 bg-yellow-400/[0.025] p-2 sm:p-2.5">
                <p className="mb-2 text-[9px] font-black uppercase tracking-[0.16em] text-yellow-300 sm:text-[11px]">
                  🟡 JE HAD DEZE ARMY KUNNEN HEBBEN
                </p>

                <div className="w-1/2 origin-left opacity-65 [&_.grid]:gap-0.5 [&_img]:h-4 [&_img]:w-4 sm:[&_img]:h-5 sm:[&_img]:w-5">
                  <ArmyContents
                    army={
            ...
            <div>
              <p className="mb-2 text-[9px] font-black uppercase tracking-[0.16em] text-orange-300/70 sm:text-[10px]">
                💀 MAAR JIJ KOOS VOOR GEWELD
              </p>
