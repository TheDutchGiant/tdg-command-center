...
export default async function ChallengeLeaderboardPage({
   ...
   *
   * De Hall of Fame gebruikt nooit de tijdelijke rank
   * van één Challenge. Alles wordt rechtstreeks uit
   * goedgekeurde resultaten opgebouwd.
   */
  const hallOfFame =
    new Map<
      string,
  ...
  for (const result of overallResults) {
    ...
    if (existing) {
      ...
      /*
       * rank 1 betekent #1 binnen die
       * specifieke Challenge + moeilijkheid.
       */
      if (result.rank === 1) {
   ...
   * GEK VAN DE WEEK
   *
   * Alleen spelers die deze week in alle drie
   * de moeilijkheden een goedgekeurde inzending
   * hebben.
   */
  const now = new Date();
        ...
        <section className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.025]">
          ...
          {!challenge ? (
            ...
            <div className="space-y-4 p-3 sm:p-5">
              ...
              <section className="overflow-hidden rounded-xl border border-emerald-400/20 bg-emerald-400/[0.03]">
                ...
                <div className="flex items-center justify-between border-b border-emerald-400/10 px-3 py-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[10px] text-white/25">
                      Beste gecombineerde prestatie
                      over alle drie de moeilijkheden.
                    </p>
                  </div>
                ...
                0 ? (
                  <div className="px-3 py-5 text-center text-xs text-white/25">
                    Nog niemand heeft deze week
                    alle drie de Challenges afgerond.
                  </div>
                ) : (
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse">
              ...
              <p className="px-1 text-[9px] text-white/20">
